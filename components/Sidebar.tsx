				...
				<ul className="space-y-2">
					<li>
						<a
							href="#"
							className={`${
								path === "/dashboard" ? "bg-moon-500" : ""
							} flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-moon-900 dark:hover:bg-gray-700`}
						>
							<AiFillHome
								className={` ${
									path === "/dashboard"
